...
(function(){
  ...
  theme.collapsibles = (function() {
    ...
    function toggle(evt) {
      ...
      var parentCollapsibleEl = container.parentNode.closest('.collapsible-content');
  ...
  theme.Parallax = (function() {
    ...
    parallax.prototype = Object.assign({}, parallax.prototype, {
      ...
      scrollHandler: function() {
        ...
        this.image.style.transform = 'translate(0, ' + shiftDistance + 'px)';
      },
  ...
  theme.PasswordHeader = (function() {
    function PasswordHeader(container) {
      this.init();
    }
